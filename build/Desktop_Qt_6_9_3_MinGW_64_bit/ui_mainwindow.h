...
public:
    ...
    QLabel *label_10;
    QSpinBox *spinBoxTimeH;
    QSpinBox *spinBoxTimeM;
    QHBoxLayout *horizontalLayout_15;
    QLabel *label_11;
    QSpinBox *spinBoxDateDay;
    QSpinBox *spinBoxDateMonth;
    QSpinBox *spinBoxDateYear;
    QWidget *page_3;
    QWidget *page_4;
    QWidget *page_5;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinBoxTimeH = new QSpinBox(pageManualInput);
        spinBoxTimeH->setObjectName("spinBoxTimeH");

        horizontalLayout_14->addWidget(spinBoxTimeH);

        spinBoxTimeM = new QSpinBox(pageManualInput);
        spinBoxTimeM->setObjectName("spinBoxTimeM");

        horizontalLayout_14->addWidget(spinBoxTimeM);
        ...
        spinBoxDateDay = new QSpinBox(pageManualInput);
        spinBoxDateDay->setObjectName("spinBoxDateDay");

        horizontalLayout_15->addWidget(spinBoxDateDay);

        spinBoxDateMonth = new QSpinBox(pageManualInput);
        spinBoxDateMonth->setObjectName("spinBoxDateMonth");

        horizontalLayout_15->addWidget(spinBoxDateMonth);

        spinBoxDateYear = new QSpinBox(pageManualInput);
        spinBoxDateYear->setObjectName("spinBoxDateYear");

        horizontalLayout_15->addWidget(spinBoxDateYear);
